 ...
 * 
 */
qx.Class.define("ae.qooxly.ui.Form", {
	
	extend : qx.ui.container.Composite,

	/**
	 * Create a new form
	 * @param param  {qx.core.Object} object that describe the parameter. See code of {@link ae.qooxly.ui.editor.Tree#loadSettings loadSettings} method
	 * @param chart  {ae.qooxly.ui.Chart} The chart widget
	 */
	construct : function(param,chart) {
		...
		switch(param.getObj().getValType()){
			...
			case "number":
				...
				break;
			case "color":
				input = new ae.qooxly.ui.ColorField(currentValue);
				input.addListener("changeValue",function(e){
					this.updatePlot(e.getData());
				},this);
				break;
