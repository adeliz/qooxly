qx.Class.define("ae.qooxly.ui.editor.Tree", {
		...
		tree.getSelection().addListener("change", function(e) {
			...
			if(selected){
				...
				if(props.indexOf("obj")!=-1){
					this.form.removeAll();
					this.form.add(new ae.qooxly.ui.Form(selected,chart),{flex:1});
				}
			}
		},this);
	...
	members:{
		...
		loadSettings : function(){
			...
			var req = new qx.io.request.Xhr("resource/ae/qooxly/plotly.json","GET");
